...
Microsoft::WRL::ComPtr<ID3D12RootSignature> Object3DConfig::CreateRootSignature(ID3D12Device* device) {
...
std::vector<D3D12_INPUT_ELEMENT_DESC> Object3DConfig::GetInputElements() {
...
void Object3DConfig::CustomSetupPSO(
